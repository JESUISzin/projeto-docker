<body style="text-align: justify">
    ...
    <div>
        ...
        <ol>
            <li>
                ...
                <pre><code>git clone https://github.com/JESUISzin/projeto-docker.git</code></pre>
            </li>
            <li>
    ...
    <div>
        ...
        <ol>
            ...
            <li>
                Finalizando o processo de configuração do worpress você será redirecionado a página de administrador.
            </li>
            <li>
                Nesta página acesse a opção de plugins, você será redirecionado para a página onde estão os plugins instalados.
            </li>
            <li>
                Ao lado da palavra Plugins no topo da pagina você terá a opção de Adicionar plugin, apertando nesse botão você será redirecionado para a pagina de instalar plugins.
            </li>
            <li>
                Pesquise na opção de busca o plugin: <code>Redis Object Cache</code>
                Aperte na opção instalar, aguarde a instalação e volte para a pagina de <code>Plugins Instalados</code>
            </li>
            <li>
    ...
    <div>
        ...
        <ol>
            <li>
                ...
                Listamos todos os containers em execução, nessa lista vamos procurar o container que está instanciando o wordpress e copiaremos o <code>CONTAINER ID</code> dele.
            </li>
            <li>
                Vamos executar o comando <code>docker exec -it [ID DO SEU CONTAINER] bash</code>, assim vamos acessar a maquina que está executando o wordpress.
            </li>
            <li>
            ...
            <li>
                ...
                <pre><code>define('WP_CACHE', true);</code></pre>
                <pre><code>define('WP_REDIS_HOST', 'redis');</code></pre>
                <pre><code>define('WP_REDIS_PORT', 6379);</code></pre>
            </li>
            <li>
            ...
            <li>
                ...
                Dessa forma é só apertar no botão "Ativar o cache de objeto" e o Redis está configurado.
            </li>
        </ol>
    </div>
    <div>
    ...
    <div>
        ...
        <ol>
            <li>
                Acessando a pagina: <code>http://localhost:3000</code> você será redirecionado para a página do grafana.
            </li>
            <li>
            ...
            <li>Após adicionar sua url vamos no final da pagina e apertar no botão "Save & test" assim podemos ir para a dashboards.</li>
            ...
            <li>Na opção Query, vamos selecionar a métrica do Prometheus e apertar em "Run Query".</li>
            <li>Assim será gerado um gráfico e podemos apertar na opção "Apply" no canto superior direito</li>
            <p>Dessa forma o gráfico do grafana será gerado.</p>
        </ol>
    </div>
    <div>
        <h2>Passo 7: Cadvisor</h2>
        <ol>
            <li> Caso queira olhar os gráficos dos contêineres e do docker podemos acessar o cadvisor pela url <code>http://localhost:8081</code>.
        </ol>
    </div>
</body>